      ...
      <p className="mt-8 text-[#777777]">
        ...
        {isSeeMore && (
          <>
            ...
            - Hannover, Mikromusik festival by Berliner Künstlerprogramm des DAAD and Humboldt Forum Foundation, Konzerthaus Berlin, Berlin Academy of Arts, 
            Center for Art & Media - ZKM, Karlsruhe, university of Music, Theater & Media Hanover, Konzerthaus Berlin (Germany);
