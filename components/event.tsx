...
const events = [
  ...
  `<b>16-26.01.2025</b>: <a style="text-decoration: underline" href=""><b>#Project Medicine Man Orchestra II</a></b> with Séidou Barassounon and Justin Adam in Cotonou, Benin.`,
