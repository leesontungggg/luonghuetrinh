...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-screen relative">
        ...
        >
          <div className="w-full h-full flex items-center justify-center text-white bg-white/25 flex-col">
            <p className="text-4xl md:text-6xl font-pacifico -mt-15">
      ...
      <div className="h-[150px] w-full flex justify-center items-center bg-white italic text-[#777777] text-sm lg:text-lg px-6">
